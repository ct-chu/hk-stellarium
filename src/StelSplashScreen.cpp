...
void SplashScreen::SplashScreenWidget::paintEvent(QPaintEvent* event)
{
	...
	p.drawText(QPointF(metrics.averageCharWidth(), 1.3*metrics.height()), QString("v0.1.0 on %1+ (v%2)").arg(StelUtils::getApplicationPublicVersion(), StelUtils::getApplicationVersion()));
#else
